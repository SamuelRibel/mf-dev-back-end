...
namespace mf_dev_back_end.Controllers
{
    ...
    {
        private readonly AppDbCoontext _context;

        public ConsumosController(AppDbCoontext context)
        {
            _context = context;
        }
        ...
        {
            var appDbCoontext = _context.Consumos.Include(c => c.Veiculo);
            return View(await appDbCoontext.ToListAsync());
        }
